...
/*
    public static final DeferredBlock<Block> MARINE_BRICKS = registerBlock("marine_bricks",
            () -> new Block(BlockBehaviour.Properties.ofFullCopy(BRICKS).strength(2.125F, 9.0F)));
*/
